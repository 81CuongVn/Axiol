...
async def levelhelp(ctx: commands.Context):
    ...
    return (
        ...
        .add_field(
            name=f"{prefix}piechart `<amount>`",
            value="Shows a Pie chart of top 10 users!",
            inline=False,
        )
        .add_field(
            name=f"{prefix}givexp `<user>` `<amount>`",
            value="Gives user more XP",
            inline=False,
        )
        .add_field(
            name=f"{prefix}removexp `<user>` `<amount>`",
            value="Removes user more XP",
            inline=False,
        )
        .add_field(
            name=f"{prefix}levelinfo",
            value="Shows the server's leveling settings",
            inline=False,
        )
        .add_field(
            name=f"{prefix}levelconfig",
            value="Configure leveling settings",
            inline=False,
        )
        .set_thumbnail(
...
async def modhelp(ctx: commands.Context):
    ...
    return (
        ...
        .add_field(
            name=f"{prefix}removewarn `<member>` `<warn_position>`",
            value="Removes the warn from the position defined from the member",
            inline=False,
        )
        .add_field(
            name=f"{prefix}warns `<member>`",
...
async def rrhelp(ctx: commands.Context):
    ...
    return (
        ...
        .add_field(
            name=f"{prefix}rr `<#channel>` `<messageid>` `<role>` `<emoji>`",
            value="Adds a reaction role",
            inline=False,
        )
        .add_field(
            name=f"{prefix}removerr `<messageid>` `<emoji>`",
        ...
        .add_field(
            name=f"{prefix}uniquerr `<messageid>`",
            value=(
        ...
        .add_field(
            name=f"{prefix}removeunique `<messageid>`",
            value=(
...
async def welcomehelp(ctx: commands.Context):
    ...
    return (
        ...
        .add_field(
            name=f"{prefix}wcard",
            value="Shows server welcome card",
            inline=False,
        )
        .add_field(
            name=f"{prefix}wchannel `<#channel>`",
            value="Changes welcome channel",
            inline=False,
        )
        .add_field(
            name=f"{prefix}wmessage",
            value="Changes welcome message",
            inline=False,
        )
        .add_field(
            name=f"{prefix}wgreeting",
            value="Changes welcome greeting",
            inline=False,
        )
        .add_field(
            name=f"{prefix}wimage",
            value="Changes the welcome image",
            inline=False,
        )
        .add_field(
            name=f"{prefix}wrole `<role>`",
...
async def automodhelp(ctx: commands.Context):
    ...
    return (
        ...
        .add_field(
            name=f"{prefix}filters",
            value="Shows all available Auto-Moderation",
            inline=False,
        )
        .add_field(
            name=f"{prefix}automodblacklist `<#channel>`",
            value=(
        ...
        .add_field(
            name=f"{prefix}automodwhitelist `<#channel>`",
            value=(
...
async def settingshelp(ctx: commands.Context):
    ...
    return (
        ...
        .add_field(
            name=f"{prefix}plugins", value="Manage your plugins", inline=False
        )
        .add_field(
            name=f"{prefix}prefix",
            value="View or change my prefix",
            inline=False,
        )
        .add_field(
            name=f"{prefix}setperm `<plugin>`",
            value=(
        ...
        .add_field(
            name=f"{prefix}removeperm `<command_name>` `<role>`",
            value=(
...
async def funhelp(ctx: commands.Context):
    ...
    return (
        discord.Embed(
            title="🎯 Fun", description="Let's have some fun!", color=var.C_MAIN
        )
        .add_field(
            name=f"{prefix}typeracer",
            value=(
        ...
        .add_field(
            name=f"{prefix}typeracer new `<player_count>`",
            value=(
...
async def giveawayhelp(ctx: commands.Context):
    ...
    return (
        discord.Embed(title="🎉 Giveaway", description="", color=var.C_MAIN)
        .add_field(
            name=f"{prefix}gstart",
        ...
        .add_field(
            name=f"{prefix}gshow",
            value="Shows all active giveaways",
            inline=False,
        )
        .set_thumbnail(
            url=(
...
class Help(commands.Cog):
    ...
    async def help(self, ctx):
        ...
        embed.add_field(
            name=f"{prefix}help extras",
            value=f"▶️ Non plugin commands",
            inline=False
        )
        ...
        try:
            while True:
                ...
                if str(reaction.emoji) in var.DICT_PLUGIN_EMOJIS.values():
                    ...
                    await help_msg.edit(
                        embed=await help_dict.get(help_type)(ctx)
                    )
    ...
    async def level_config(self, ctx):
        ...
        embed = (
            discord.Embed(
                title="Configure leveling for this server", color=var.C_TEAL
            )
            .add_field(
                name=f"{prefix}xprange `<leastamount>` `<highestamount>`",
                value=(
            ...
            .add_field(
                name=f"{prefix}blacklist `<#channel>`",
                value="Add the channel where you don't want users to gain xp.",
                inline=False,
            )
            .add_field(
                name=f"{prefix}whitelist `<#channel>`",
                value="Whitelist an xp blacklisted channel.",
                inline=False,
            )
            .add_field(
                name=f"{prefix}alertchannel `<#channel>`",
                value="Define the channel where alerts will be sent for level ups!",
                inline=False,
            )
            .add_field(
                name=f"{prefix}togglealerts",
                value="Disable or Enable alert message for level ups!",
                inline=False,
            )
            .add_field(
                name=f"{prefix}reward `<level>` `<role>`",
                value=(
            ...
            .add_field(
                name=f"{prefix}removereward `<level>`",
